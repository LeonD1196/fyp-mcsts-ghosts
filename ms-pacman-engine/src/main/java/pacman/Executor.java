...
public class Executor {
    ...
    public static class Builder {
        ...
        private POType poType = POType.FULL;
...
//            }
     ...
     * @param ghostController  The Ghosts controller
     */
    void runGameTimed(Controller<MOVE> pacManController, Legacy ghostController) throws IOException {
        Game game = setupGame();

        FileWriter fw = new FileWriter("/home/leon/Documents/college/fyp/testing/results/new-version/legacy.txt", true);
...
//        MASController ghostControllerCopy = ghostController.copy(ghostPO);
    ...
    /**
     * For Running a game with Random Ghosts
     */
    public void runRandomGameTimed(Controller<MOVE> pacManController, Legacy ghostController) throws IOException {
        Game game = setupGame();
