...
public class GhostPOComparison {
    ...
    public static void main(String[] args) {
        ...
        for(POType type : POType.values()){
            ...
            System.out.println("Distance to ghost: " + copy.getDistance(copy.getGhostCurrentNodeIndex(Constants.GHOST.INKY), copy.getPacmanCurrentNodeIndex(), Constants.DM.PATH));
        }
